...
class Chat extends StatelessWidget {
  ...
  Chat({Key key, @required this.peerId, @required this.peerAvatar, this.id})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromRGBO(189, 44, 98, 1),
        toolbarHeight: 70,
        actions: [
          Container(
            width: 70,
...
class ChatScreen extends StatefulWidget {
  ...
  @override
  State createState() =>
      ChatScreenState(peerId: peerId, peerAvatar: peerAvatar, id: id);
}
